<?php
  ...
  class Carrinho extends ConexaoMysql{
   ...
   function calcula_frete($cep_destino="",$peso_frete=0,$nCdServico="41106"){
    $valores = array();

    if(!empty($cep_destino)) {

      /* $resultado = @file_get_contents('http://republicavirtual.com.br/web_cep.php?cep='.$cep_destino.'&formato=json');
