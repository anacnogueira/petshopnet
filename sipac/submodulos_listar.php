...
//Pegar variaveis de Filtro
 ...
 $arraCampoNome	  = array("Submódulo","Módulo","ID");
 $arraCampoValor  = array("submodulos_nome","modulos_nome","submodulos_id","submodulos_ordem");
 ...
 $sql = "SELECT
 submodulos_id, submodulos_nome, submodulos_ordem,modulos_nome
 FROM submodulos
 ...
 if($recordCount1 >0)
 {
   for ($indx = 0; $indx < $reg_pag; $indx++)
   {
      ...
      $lista	.=	"	<td class='Sels'><input type='checkbox' class='checkbox' name='sels[]' value='". $linha["submodulos_id"]."' /></td>\n";
   	  $lista	.=	"	<td>". $linha["submodulos_nome"]."</td>\n";
   	  $lista	.=	"	<td>". $linha["modulos_nome"]."</td>\n";
   	  $lista	.=	"	<td>". $linha["submodulos_ordem"]."</td>\n";
      $lista  .=  $rotinaClass->menu_rotinas_interno($linha["submodulos_id"]);
   	  $lista	.=	"</tr>\n";
   }
 }
 else
...
<div id="conteudo">
     ...
     <? $rotinaClass->menu_rotinas_superior(); ?>
       ...
       <td class="ordenarLista" id="i0">Submódulo <?= ordenacao(0) ?></td>
       <td class="ordenarLista" id="i1">Módulo <?= ordenacao(1) ?></td>
       <td class="ordenarLista" id="i3">Ordem <?= ordenacao(3) ?></td>
