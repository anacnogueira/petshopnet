<?
 /*--------------------------------------------------------'
   ...
   Página: produtos_esperados_listar.php	                '
---------------------------------------------------------*/
 $form        = "frm_produto";
...
//Pegar variaveis de Filtro
 ...
 $arraCampoNome		= array("Produto","Data lançamento");
 ...
 else
 {
  ...
  if(!empty($palavraChave) and !empty($arraCampoValor[$campo]))
  {
   ...
   elseif(strtoupper($arraCampoNome[$campo]) == "DATA LANçAMENTO")
     ...
     <? $rotinaClass->menu_rotinas_superior(); ?>
   	 <table class="TableLista" border='0' cellpadding='0' cellspacing='2'>
     	<tr class='cabecalho'>
          ...
          <td style='width:150px' class="ordenarLista" id="i1">Data de lançamento <?= ordenacao(1) ?></td>
