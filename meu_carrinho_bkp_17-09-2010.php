 ...
 <h1><?=$title ?></h1>
  <? if($qtdeCarrinho > 0) { ?>
    <form id="frm_carrinho" action="meu_carrinho.php?acao=modificar" method="post" >
     <input name="peso_frete" type="hidden" value="<?= str_replace(".",",",$peso_frete) ?>" />
      <table border="0" class='tbl_carrinho' cellspacing='0'>
        ...
        <tr class='frete'>
          ...
          <td colspan="2"><input name="valor_frete" type="text" size="10" readonly="readonly" value="<?= !empty($valor_frete)?number_format($valor_frete,2,",","."):"" ?>" class="readonly" /></td>
        </tr>
