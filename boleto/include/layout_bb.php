...
#instr_header {
	background: url('http://www.petshopnet.com.br/loja_teste/banco_imagens/logo.gif') no-repeat top left;
	padding-left: 160px;
	height: 120px;
}
...
<div id="container">
	...
	<div id="instr_header">
		...
		<address><?php echo $dadosboleto["bairro"]; ?> - CEP: <?php echo $dadosboleto["cep"]; ?><br></address>
		<address><?php echo $dadosboleto["cidade_uf"]; ?><br /></address>
		<address>CNPJ: <?php echo $dadosboleto["cpf_cnpj"]; ?></address>
	</div>	<!-- id="instr_header" -->
...
<!--
 ...
 -->
	...
	<div id="boleto">
		...
		<div align='center'><input name="btn_imprimir" type="button" value=" IMPRIMIR " onclick="top.print();" class="noprint" /></div>
	</div>
